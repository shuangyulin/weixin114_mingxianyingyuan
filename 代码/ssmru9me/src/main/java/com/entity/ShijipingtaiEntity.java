...
public class ShijipingtaiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShijipingtaiEntity() {
		
	}
	
	public ShijipingtaiEntity(T t) {
		try {
	 ...
	 * 设置：物品金额
	 */
	public void setWupinjine(String wupinjine) {
		this.wupinjine = wupinjine;
	}
	/**
	 * 获取：物品金额
	 */
	public String getWupinjine() {
		return wupinjine;
	}
	/**
	 * 设置：账号
