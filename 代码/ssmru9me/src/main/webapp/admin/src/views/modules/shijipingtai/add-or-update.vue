<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品金额" prop="wupinjine">
          <el-input v-model="ruleForm.wupinjine" 
              placeholder="物品金额" clearable  :readonly="ro.wupinjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品金额" prop="wupinjine">
              <el-input v-model="ruleForm.wupinjine" 
                placeholder="物品金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="物品详情" prop="wupinxiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wupinxiangqing" label="物品详情" prop="wupinxiangqing">
                    <span>{{ruleForm.wupinxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="手机" prop="shouji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shijipingtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shijipingtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
