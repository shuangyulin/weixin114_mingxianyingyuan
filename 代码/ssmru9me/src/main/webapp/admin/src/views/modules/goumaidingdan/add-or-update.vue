<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="订单号" prop="dingdanhao">
            <el-input v-model="ruleForm.dingdanhao" 
                placeholder="订单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dingdanhao" label="订单号" prop="dingdanhao">
              <el-input v-model="ruleForm.dingdanhao" 
                placeholder="订单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品价格" prop="wupinjiage">
          <el-input v-model="ruleForm.wupinjiage" 
              placeholder="物品价格" clearable  :readonly="ro.wupinjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品价格" prop="wupinjiage">
              <el-input v-model="ruleForm.wupinjiage" 
                placeholder="物品价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买金额" prop="goumaijine">
            <el-input v-model="goumaijine"
                placeholder="购买金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goumaijine" label="购买金额" prop="goumaijine">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="地址" prop="dizhi">
                <el-input
...
export default {
  ...
  computed: {
    goumaijine:{
      get: function () {
        return 1*this.ruleForm.wupinjiage*this.ruleForm.goumaishuliang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.goumaijine = this.goumaijine
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
